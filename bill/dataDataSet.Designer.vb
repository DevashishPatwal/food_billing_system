...
Partial Public Class dataDataSet
    ...
    Partial Public Class itemDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AdditemRow(ByVal Item As String, ByVal Price As Integer) As itemRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByItem(ByVal Item As String) As itemRow
            Return CType(Me.Rows.Find(New Object() {Item}),itemRow)
        End Function
...
Namespace dataDataSetTableAdapters
    ...
    Partial Public Class itemTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Item` WHERE ((`Item` = ?) AND ((? = 1 AND `Price` IS NULL) OR (`Pric"& _ 
                "e` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Item` (`Item`, `Price`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Item` SET `Item` = ?, `Price` = ? WHERE ((`Item` = ?) AND ((? = 1 AND `Pr"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Item, Price FROM item"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As dataDataSet.itemDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As dataDataSet.itemDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As dataDataSet.itemDataTable = New dataDataSet.itemDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As dataDataSet.itemDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Item As String, ByVal Original_Price As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Item As String, ByVal Price As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Item As String, ByVal Price As Global.System.Nullable(Of Integer), ByVal Original_Item As String, ByVal Original_Price As Global.System.Nullable(Of Integer)) As Integer
            If (Item Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Item")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Price As Global.System.Nullable(Of Integer), ByVal Original_Item As String, ByVal Original_Price As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_Item, Price, Original_Item, Original_Price)
        End Function
    End Class
